          ...
          <div className="modal-body">
            ...
            <div className="modal-info">
              ...
              <div className="modal-links">
                {project.githubUrl && (
                  <a href={project.githubUrl} target="_blank" rel="noreferrer" className="modal-link-btn github-btn" title="Source Code" aria-label="Source Code">
                ...
                {project.demoUrl && (
                  <a href={project.demoUrl} target="_blank" rel="noreferrer" className="modal-link-btn demo-btn" title="Live Demo" aria-label="Live Demo">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
